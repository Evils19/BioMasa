...
{
    public class AiModelAccess : IDisposable
    {
        ...
        public AiModelAccess(string apiKey)
        {
            _httpClient = new HttpClient
            {
                Timeout = TimeSpan.FromMinutes(5) // Creștem timeout-ul pentru procesarea imaginilor mari
            };
